...
import pl.chojnacki.grzegorz.testing.order.OrderStatus;
...
class CartServiceTest {
    ...
    void processCartShouldSendToPrepare() {
        ...
        then(cartHandler).should().sendToPrepare(cart);  // Using then() from BDD Mockito library
    ...
    void processCartShouldNotSendToPrepare() {
        ...
        then(cartHandler).should(never()).sendToPrepare(cart);  // Using then() from BDD Mockito library
        assertThat(resultCart.getOrders(), hasSize(1));
    ...
    void processCartShouldNotSendToPrepareWithArgumentMatchers() {
        ...
        then(cartHandler).should(never()).sendToPrepare(any(Cart.class));  // Using then() from BDD Mockito library
        assertThat(resultCart.getOrders(), hasSize(1));
        assertThat(resultCart.getOrders().get(0).getOrderStatus(), equalTo(OrderStatus.REJECTED));
